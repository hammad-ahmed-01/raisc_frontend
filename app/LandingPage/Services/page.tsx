	...
	return (
		...
		>
			...
			<div className="relative z-10 max-w-7xl mx-auto text-center">
				...
				{/* Section Title */}
				<h2 className="text-2xl md:text-3xl text-center font-extrabold text-heading">
					Our Services
				</h2>
				...
				{/* First Heading */}
				<h3 className="text-xl text-heading font-bold mt-6">
				...
				<div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-16 px-2">
					{services
						.slice(0, 3)
						.map(
							({ heading, image, description, backgroundColor }) => (
								<Card
									key={heading}
									image={image}
									heading={heading}
