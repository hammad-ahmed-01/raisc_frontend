...
export default function HeroSection() {
  return (
    <section 
      id="home" 
      className="relative  text-center px-4 pt-20 md:pt-24 lg:pt-28 pb-32 bg-blue-50"
    >
      <h1 className="text-heading md:text-4xl font-bold [text-shadow:_2px_2px_4px_rgba(0,0,0,0.3)]">
        Welcome to RAISC
      </h1>
